...
- [Loss_Frame](Loss_Frame/references.md): Prompts and results from asking ChatGPT to come up with the campaign idea through the lens of a loss frame.
- [Gain_Frame](Gain_Frame/references.md): Prompts and results from asking ChatGPT to come up with the campaign idea through the lens of a gain frame.
